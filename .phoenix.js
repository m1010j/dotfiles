...
const COMMAND_ALT = ['cmd', 'alt'];
const COMMAND_ALT_SHIFT = ['cmd', 'alt', 'shift'];
 ...
 */
Key.on('l', COMMAND_ALT_SHIFT, function(){
 ...
 */
Key.on('h', COMMAND_ALT_SHIFT, function(){
